...
const ForgotPasswordPage = () => {
    ...
    const onSubmit = async (values: ForgotPasswordData, { setSubmitting, setErrors }: FormikHelpers<ForgotPasswordData>) => {
        try {
            const data = {
                email: values.email,
            ...
            const authentication = await ForgotPassword(data); // fetch para llamar función de autenticación
